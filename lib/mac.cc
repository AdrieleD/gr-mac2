...
//#endif
    ...
    bool stop() {
        ...
        std::cout << "Time:" << finalTime << ":ms" << std::endl;
        std::cout << "Data sent:" << numPackEnviados << std::endl;
        std::cout << "Data confirmed:" << numPackConfirmados << std::endl;
        std::cout << "Data retransmissions: " << numRetransmissoes << std::endl;
        std::cout << "FlowPs: " << numPackConfirmados / (finalTime / 1000) << " Ppckages/s" << std::endl;
        std::cout << "FlowBs:" << numPackConfirmados * 110 / (finalTime / 1000) << " bytes/s" << std::endl; // tamanho fixo de pacote com 110 bytes
        std::cout << "Rate:" << double(numPackConfirmados)/numPackEnviados * 100 << " percent" << std::endl;
        std::cout << "Latency:";// << finalTime/numPackConfirmados << " ms" << std::endl;
